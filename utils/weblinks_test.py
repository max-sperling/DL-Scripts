...
class test_url_Overlap(unittest.TestCase):
    ...
    def test_with_same_base_dirs_1(self):
        ...
        self.assertEqual(weblinks.Url_Overlap.calculate(url1, url2), weblinks.Url_Overlap.DIRS)
